...
class TestKeyphraseCrud:
    def test_crud(self, full_dataset: Dataset):
        ...
        keyphrase1 = Keyphrase(text="cat", keyphrase_id="cat", ancestors=[], parents=[], level=0, keyphrase_score=1.1,
                               frequency=2, metadata={})
        keyphrase2 = Keyphrase(text="cat", keyphrase_id="dog", ancestors=["cat"], parents=["cat"],
                               level=1, keyphrase_score=1.1, frequency=1, metadata={})
