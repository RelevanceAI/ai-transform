...
class TestDocument:
    ...
    def test_split(self):
        ...
        def split_text_into_sentences_max(text, language, max_number_of_chunks: int = 20):
        ...
        [d.split(split_function, chunk_field="_chunks_.sentence", field="sentence") for d in documents]
        ...
        assert documents[0] == {
            ...
            "_chunks_": {
                "sentence": [
                    ...
                    {"sentence": "Won't it be?", "_order_": 1, "_offsets_": [{"start": 52, "end": 63}]},
                ]
            },
        }
